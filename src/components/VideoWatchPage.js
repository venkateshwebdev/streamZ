...
const VideoWatchPage = () => {
    ...
    return !videoDetails?<VideoWatchShimmer />:(<div className="videowatch-container">
        ...
        <div className="videoWatch-channel"><h4>{videoDetails?.snippet?.channelTitle}</h4><span>{channelDetails?.subscriberCount>1000000?(channelDetails?.subscriberCount/1000000).toFixed(1)+"M":(channelDetails?.subscriberCount/10000).toFixed(1)+" K"} Subscribers</span></div>
